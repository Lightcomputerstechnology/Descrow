...
const ContactSection = () => {
  ...
  return (
    <footer id="contact" className="bg-gray-950 dark:bg-black text-white py-12 border-t border-gray-800 transition-colors duration-300">
      <motion.div
        ref={ref}
        initial={{ opacity: 0 }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#api" className="text-gray-400 hover:text-white transition-colors duration-200">API</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/admin/login" className="text-gray-400 hover:text-blue-400 transition-colors duration-200">Admin Portal</Link></li>
            </ul>
          </div>
        </div>
